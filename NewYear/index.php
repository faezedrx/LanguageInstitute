    ...
    <div class="container max-w-lg mx-auto p-6" data-aos="fade-up">
        <div>
            ...
            <h1 class="glow-text text-center">
              عزیز<span class="mobile-break"><br></span> نوروزتان پیروز
            </h1>

	
            </p>
            <p class="mt-4 text-gray-600 font-semibold text-right">
                سال نو سرشار از سلامتی، شادی و موفقیت‌های بزرگ برای شما باد 
            <p class="mt-4 text-gray-600 font-semibold text-center">
                نوروزتان پر از نور و گرمی همان‌گونه که حضورتان برای ما پر از انرژی و انگیزه است
            </p>
            </p>
